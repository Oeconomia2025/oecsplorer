...
const PROTOCOL_ABIS: Record<string, string[]> = {
  ...
  alluria: [
    // TroveManager
    "function openTrove(address collateral, uint256 collateralAmount, uint256 alud_amount) external",
    "function closeTrove(address collateral) external",
    "function addCollateral(address collateral, uint256 amount) external",
    "function removeCollateral(address collateral, uint256 amount) external",
    "function mintALUD(address collateral, uint256 amount) external",
    "function repayALUD(address collateral, uint256 amount) external",
    "function liquidate(address troveOwner, address collateral) external",
    "function redeemCollateral(address collateral, uint256 alud_amount, address troveOwner) external",
    // StabilityPool
    "function depositALUD(uint256 amount) external",
    "function withdrawALUD(uint256 amount) external",
    "function claimCollateralGains() external",
    "function claimOECRewards() external",
    // EmissionsVault
    ...
    "function approve(address spender, uint256 amount) external returns (bool)",
    // Events
    "event TroveOpened(address indexed owner, address indexed collateral, uint256 collateralAmount, uint256 debt, uint256 fee)",
    ...
    "event TroveLiquidated(address indexed owner, address indexed collateral, address indexed liquidator, uint256 collateralLiquidated, uint256 debtAbsorbed, uint256 bonus)",
    "event Redeemed(address indexed redeemer, address indexed collateral, uint256 alud_amount, uint256 collateralReturned, uint256 fee)",
    "event Deposited(address indexed user, uint256 amount)",
    "event Withdrawn(address indexed user, uint256 amount)",
    "event LiquidationAbsorbed(address indexed collateral, uint256 collateralAmount, uint256 debtAbsorbed)",
    "event OECRewardsClaimed(address indexed user, uint256 amount)",
    "event OECReleased(address indexed stabilityPool, uint256 amount, uint256 totalReleased, uint256 vaultBalance, uint256 timestamp)",
  ],
  eloqura: [
    // ── V2 Router ──
